{
  ...
  inputs = {
    ...
    opencode-linux-x64 = {
      url = "https://github.com/sst/opencode/releases/download/v1.1.45/opencode-linux-x64.tar.gz";
      flake = false;
    };
    opencode-linux-arm64 = {
      url = "https://github.com/sst/opencode/releases/download/v1.1.45/opencode-linux-arm64.tar.gz";
      flake = false;
    };
    opencode-darwin-arm64 = {
      url = "https://github.com/sst/opencode/releases/download/v1.1.45/opencode-darwin-arm64.zip";
      flake = false;
    };
  };
